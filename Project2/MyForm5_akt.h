...
namespace Project2 {
	...
	/// <summary>
	/// Summary for MyForm5_akt
	/// </summary>
	public ref class MyForm5_akt : public System::Windows::Forms::Form
	{
		Form^ f1;
	public:
		MyForm5_akt(Form^ f2)
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyForm5_akt::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &MyForm5_akt::button1_Click);
			// 
			// textBox3
			// 
			...
			this->Name = L"MyForm5_akt";
			this->Text = L"AKT sohasida kasb ta\'limi";
			this->Load += gcnew System::EventHandler(this, &MyForm5_akt::MyForm5_akt_Load);
...
#pragma endregion
	private: System::Void MyForm5_akt_Load(System::Object^ sender, System::EventArgs^ e) {
	}
